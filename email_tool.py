...
IMAP_SERVER = os.environ.get("IMAP_SERVER", "imap.qq.com") # Assuming QQ for IMAP as well
EMAIL_USER = os.environ.get("EMAIL_USER", "1051356786@qq.com")
EMAIL_PASS = os.environ.get("EMAIL_PASS", "ebxmiczegeuvbaii")
